...
public class Scheduler extends Thread {
    ...
    public Scheduler(RequestQueue queue, Supervisor supervisor, Tunnel visor) {
        this.visor = visor;
            ...
            synchronized (visor) {
                ...
                for (int k = 0; k < queue.size(); k++) {
                    if (queue.get(k) instanceof PersonRequest) {
                        ...
                        // System.out.println(personRequest +" thrown");
